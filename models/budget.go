...
type Budget struct {
	...
	StartDate       time.Time `json:"start_date" gorm:"type:timestamp with time zone;not null"`
	EndDate         time.Time `json:"end_date" gorm:"type:timestamp with time zone;not null"`
